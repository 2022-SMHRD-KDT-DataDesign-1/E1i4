...
public class testimonialVO {
	...
	public testimonialVO(String board_id, String member_id, String movie_id, String member_comment, String review_date,
			...
			String movie_rate, String movie_time, String synopsis, String trailer, String movie_age, String youtube_id,
			String youtube_type, String youtuber, String youtube_title, String youtube_link) {
		super();

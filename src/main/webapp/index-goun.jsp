			...
			<div class="navbar-nav ms-auto p-4 p-lg-0">
				...
				<div class="nav-item dropdown">
					...
					<div class="dropdown-menu fade-down m-0" id="dropdown-mypage"
						...
						<a href="team.jsp" class="dropdown-item">보관함</a> <a href=""
							class="dropdown-item">설정</a> <a href="Login_1.jsp"
...
>>>>>>> branch 'master' of https://github.com/2022-SMHRD-KDT-DataDesign-1/E1i4.git
	...
	<div class="container-xxl py-5" style="width: 100%">
		<h4 class="show-movie-item-text"
			style="margin-bottom: 25px; font-weight: bold;">드라마</h4>
		<div class="container">
...
=======
				<a href="testimonial.jsp?movie_id=<%=M.getMovie_id()%>">
...
<<<<<<< HEAD
	<div class="container-xxl py-5" style="width: 100%">
		<h4 class="show-movie-item-text" style="margin-bottom: 25px;">애니</h4>
		<div class="container">
			<div class="slick-service-item row g-4 col-lg-3 col-sm-6"
				style="width: 1350px;">
				<%for(indexVO M : list){ %>
...
<<<<<<< HEAD
	<div class="container-xxl py-5" style="width: 100%">
		<h4 class="show-movie-item-text" style="margin-bottom: 25px;">공포</h4>
		<div class="container">
			<div class="slick-service-item row g-4 col-lg-3 col-sm-6"
				style="width: 1350px;">
				<%for(indexVO M : list){ %>
...
<<<<<<< HEAD
	<div class="container-xxl py-5" style="width: 100%">
		<h4 class="show-movie-item-text" style="margin-bottom: 25px;">SF</h4>
		<div class="container">
			<div class="slick-service-item row g-4 col-lg-3 col-sm-6"
				style="width: 1350px;">
				<%for(indexVO M : list){ %>
...
<<<<<<< HEAD
	<div class="container-xxl py-5" style="width: 100%">
		<h4 class="show-movie-item-text" style="margin-bottom: 25px;">스릴러</h4>
		<div class="container">
			<div class="slick-service-item row g-4 col-lg-3 col-sm-6"
				style="width: 1350px;">
				<%for(indexVO M : list){ %>
